...
namespace Models
{
    ...
    public class Student
    {
        ...
        public Student(NumarMatricol nr_matricol, PlainText nume, NumeFacultate facultate, Serie serie, An an)
        {
        ...
        {
            return string.Format("Nume: {0}, Numar Matricol: {1}, An Studiu: {2}, Facultate: {3}, Serie: {4}", Nume,NumarMatricol,An,Facultate,Serie);
        }
